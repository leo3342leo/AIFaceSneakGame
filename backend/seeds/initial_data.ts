...
export async function seed(knex: Knex): Promise<any> {
    ...
    const users = await knex('users').insert([
        {username: 'Andy', password:'123', elo:3, hi_score:99, gold:10000},
        {username: 'Leo', password:'123', elo:4, hi_score:999, gold:100000},
        {username: 'Barry', password:'123', elo:5, hi_score:9999, gold:1000000}
    ]).returning('id')
